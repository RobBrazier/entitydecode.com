		...
		<>
			...
			<div class="space-y-2" style={{ display: open() ? "block" : "none" }}>
				<p>
					...
					characters, such as <code>%24</code> in URLs, and HTML entities such
					as <code>&amp;raquo;</code> into their proper characters (you can try
					both of those down below if you want!).
				</p>
				<p>
